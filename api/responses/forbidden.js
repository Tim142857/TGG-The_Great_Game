...
module.exports = function forbidden(data, options) {
    ...
    // work, just send JSON.
    if (options.view) {
        return res.view(options.view, {data: viewData, title: 'Forbidden', layout: 'layouts/layoutVisitor'});
    }

    // If no second argument provided, try to serve the default view,
    // but fall back to sending JSON(P) if any errors occur.
    else return res.view('403', {data: viewData, title: 'Forbidden', layout: 'layouts/layoutVisitor'}, function (err, html) {
